...
void Initialize(void)
{
    ...
    glClearColor(8.0f/255.0f, 7.0f/255.0f, 5.0f/255.0f, 1.0f); //Change the background to sky blue
    if (EnableLight) {
...
void GameStatus() {
    ...
    sprintf(sprintf_s, "Points: %d", points);
    Write(sprintf_s);
}
